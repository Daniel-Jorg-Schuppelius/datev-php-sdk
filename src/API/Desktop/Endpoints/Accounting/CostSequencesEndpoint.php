 ...
 * Filename     : CostSequencesEndpoint.php
 * License      : MIT License
...
class CostSequencesEndpoint extends EndpointAbstract implements SearchableEndpointInterface {
    ...
    public function get(?ID $id = null): ?CostSequence {
        if (is_null($id)) {
            return null;
        }
