 ...
 * Filename     : PostingProposalRulesCashRegisterEndpoint.php
 * License      : MIT License
...
class PostingProposalRulesCashRegisterEndpoint extends EndpointAbstract implements SearchableEndpointInterface {
    ...
    protected function getBaseUrl(): string {
        ...
        return "{$this->getEndpointUrl()}/{$this->clientId->toString()}/fiscal-years/{$this->fiscalYearId->toString()}/posting-proposal-rules-cash-register";
    }
    ...
    public function search(array $queryParams = [], array $options = []): ?PostingProposalRules {
        ...
        }, 'Searching PostingProposalRules (CashRegister)');
    }
}
