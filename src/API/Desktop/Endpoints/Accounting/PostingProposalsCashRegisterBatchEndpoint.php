 ...
 * Filename     : PostingProposalsCashRegisterBatchEndpoint.php
 * License      : MIT License
...
class PostingProposalsCashRegisterBatchEndpoint extends EndpointAbstract implements PostableEndpointInterface {
    ...
    public function create($data): ?array {
        ...
        }, 'Creating PostingProposals (CashRegister Batch)');
    }
}
