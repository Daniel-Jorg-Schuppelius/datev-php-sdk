...
namespace Datev\Entities\Accounting\Debitors;
...
class Debitor extends NamedEntity implements IdentifiableNamedEntityInterface {
    protected DebitorID $id;
    ...
    public function getID(): DebitorID {
        return $this->id;
    }
