...
class HealthInsurance extends NamedEntity {
    ...
    public function getHealthInsuranceEmployeesContributionTotal(): ?Money {
        return $this->toMoney($this->health_insurance_employees_contribution_total ?? null);
    }

    public function getHealthInsuranceEmployerContributionTotal(): ?Money {
        return $this->toMoney($this->health_insurance_employer_contribution_total ?? null);
    }
}
